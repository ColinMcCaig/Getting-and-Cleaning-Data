...
# select only those columns that includes data of mean or standard deviation
data_sets_mean_std <- data_sets[,features_mean_std_index]


## Uses descriptive activity names to name activities in data set

# replace activity number in labels with activity name 
...
# select features name and makes readable
...
## creates second independent tidy data set with average of each variable for each activity and each subject.
